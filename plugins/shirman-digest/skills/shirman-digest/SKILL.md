...
Скилл автоматически собирает самое важное за день из мира AI и технологий с [shir-man.com/homepage/](https://shir-man.com/homepage/) — SPA-дашборда, агрегирующего GitHub Trending, Hacker News, Lobsters и AI-новости. Результат — готовый HTML-отчёт с 4 вкладками (без дублей), темой и ссылками на оригиналы.
...
**4 вкладки** (без дублей между разделами):
...
**Правило дедупликации:** Каждая статья/проект появляется ТОЛЬКО в одной вкладке. Приоритет размещения: AI Agents (если про AI инструмент) → GitHub Trending (если репозиторий) → Hacker News (если HN источник) → Lobsters. Если статья появилась на HN и Lobsters — оставить там где больше очков. Deep Reads, Обзор, Попробовать — УБРАНЫ, их контент распределяется по 4 основным вкладкам.

**Убранные вкладки и причины:**
- ~~Обзор~~ — пересказ того что уже есть в остальных вкладках
- ~~Deep Reads~~ — 100% дубли из HN/Lobsters/AI Agents
- ~~Попробовать~~ — частично дубли AI Agents + GitHub Trending
...
<body>
  ...
  <nav class="tabs"><!-- 4 вкладки: GitHub Trending, HN, Lobsters, AI Agents --></nav>
