...
### Шаг 1.7: Three-Question Filter (обязательно)

Перед чтением полных статей — прогнать каждую карточку через фильтр:

| Вопрос | Проходит если... |
|--------|-----------------|
| **Novelty** — это реально новое или пережёванная документация? | Новый проект, свежий релиз, оригинальный подход |
| **Credibility** — подкреплено production usage или это engagement bait? | Есть GitHub stars, production users, benchmarks |
| **Applicability** — решает реальную проблему в наших workflow? | Применимо к antomate, Arcadia, или личному стеку |

Карточки прошедшие 0/3 — исключить из отчёта. 1/3 — в категорию "Попробовать" с пометкой. 2-3/3 — в основные вкладки. Фильтр отсеивает ~80% шума и экономит WebFetch вызовы.
